...
public class Sovellus {
    ...
    private static IO ConsoleIO = new ConsoleIO();

    private static void lisaa() {
        int lisattavaLuku;
        IntJoukko joukko;
        System.out.print("Mihin joukkoon? ");
        joukko = ConsoleIO.valitseJoukko(A, B, C);
        System.out.println("");
        System.out.print("Mikä luku lisätään? ");
        lisattavaLuku = ConsoleIO.lueKokonaisluku();
    ...
    private static void yhdiste() {
        ...
        aJoukko = ConsoleIO.valitseJoukko(A, B, C);
        System.out.print("2. joukko? ");
        bJoukko = ConsoleIO.valitseJoukko(A, B, C);
    ...
    private static void poista() {
        ...
        lisLuku = ConsoleIO.lueKokonaisluku();
    ...
    private static void kuuluu() {
        ...
        kysLuku = ConsoleIO.lueKokonaisluku();
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            luettu = ConsoleIO.lueMerkkijono();
